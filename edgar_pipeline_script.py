...
#CIK = "0001408198"  # Example for MSCI

# === FILES ===
EXCEL_FILE = "Updater_EDGAR.xlsm"
SHEET_NAME = "Raw_data"

#==== REMOVE CONFIG & SETUP (EVERYTHING ABOVE THIS LINE IN THIS CELL) IN CONVERTING TO FUNCTION ====
...
summary_path = f"{TICKER}_{QUARTER}Q{str(YEAR)[-2:]}_summary_metrics.json"
